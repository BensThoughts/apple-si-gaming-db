...
import type { PrismaSiteAchievement } from '~/interfaces/database';
...
type ProfileAchievementsLoaderData = {
  siteAchievements: {
    achievementId: PrismaSiteAchievement['achievementId'];
    title: PrismaSiteAchievement['title'];
    description: PrismaSiteAchievement['description'];
    imageUrl: PrismaSiteAchievement['imageUrl'];
    svgCode: PrismaSiteAchievement['svgCode'];
  }[]
}
