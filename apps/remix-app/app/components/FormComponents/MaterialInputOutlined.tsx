  ...
  return (
    <div className="relative group rounded bg-primary w-full">
      <input
        ...
        id={id}
        type="text"
        className={classNames('outline-none peer bg-transparent w-full', inputSizeClassnames)}
        placeholder=" "
      ...
      <label
        ...
        className={classNames(
            'absolute left-[9px] -top-[1px] text-sm transition-all',
            'duration-300 px-1 transform -translate-y-1/2 pointer-events-none',
            'peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-xl',
            'group-focus-within:!-top-[1px] group-focus-within:!text-sm',
            'group-focus-within:text-tertiary',
            fieldError ? 'text-error' : 'text-primary',
        )}
      >
        {label}
      </label>
      ...
      <fieldset
        className="inset-0 absolute border border-secondary-highlight rounded
      ...
      >
        <legend
          className="ml-2 px-0 text-sm transition-all duration-300 invisible
                     max-w-[0.01px] group-focus-within:max-w-full whitespace-nowrap
      ...
      <fieldset
        className="inset-0 absolute border border-secondary rounded
