...
export default function MaterialTextAreaSolid({
  name,
  label,
  errorMessage,
}: {
  ...
  return (
    <div className="overflow-hidden relative w-full rounded bg-primary" key={name}>
      <label
        htmlFor={`${name}-input`}
        className={classNames(
            ...
            'peer-placeholder-shown:text-[1.2rem] peer-placeholder-shown:translate-y-0',
            'text-[0.75rem] -translate-y-[14px]',
      ...
      <textarea
        ...
        className={classNames(
            'peer focus:outline-none bg-transparent border-0',
            'text-primary block text-[1.2rem] mt-[24px] pt-0 px-[12px] pb-[10px] w-full',
            'focus-visible:outline-none border-b-2 min-h-[250px]',
