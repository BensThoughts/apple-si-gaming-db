...
const Placeholder = () => {
  return (
    <div className="absolute top-[63px] left-4 opacity-50 pointer-events-none overflow-hidden overflow-ellipsis select-none inline-block">
      Create Post...
    </div>
  );
};
  ...
  return (
    <div
      ...
      className={classNames(
          ...
          'w-full',
          'border-slate-500 bg-primary border-2 rounded-md focus-within:outline-none focus-within:border-slate-900 dark:focus-within:border-slate-400',
      )}
    >
      <LexicalEditor
        config={{
