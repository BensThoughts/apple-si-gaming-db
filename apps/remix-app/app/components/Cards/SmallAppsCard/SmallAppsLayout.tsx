...
import OwnedAppDisplay from './SmallAppDisplayCard';
import RoundedButton from '~/components/RoundedButton';
import type { SteamAppForSmallDisplayCard } from '.';

function computeGenreOptions(ownedApps: SteamAppForSmallDisplayCard [], ALL_FILTER: SelectOption) {
...
export default function SmallAppsLayout({
  steamApps,
}: {
