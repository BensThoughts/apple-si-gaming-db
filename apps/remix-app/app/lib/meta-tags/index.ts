...
export const metaTags = {
  ...
  'og:type': 'website',
  'og:title': TITLE,
  'og:description': 'Read and write performance reviews about Steam games running on Apple',
  ...
  'twitter:title': TITLE,
  'twitter:description': 'Read and write performance reviews about Steam games running on Apple',
